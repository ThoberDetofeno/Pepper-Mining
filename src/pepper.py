...
from utils.enum import EventColumn, Variant, Flowchart
from kpi.pepper_kpi import PepperKpi
# TODO: Call the KPIs class of a dynamically imported module (__kpi)
from kpi.number_of_cases import NumberOfCases
from kpi.throughput_time import ThroughputTime
from kpi.average_events_per_case import AverageEventsPerCase
from kpi.number_of_events import NumberOfEvents
from kpi.number_of_activities import NumberOfActivities
from kpi.rework import Rework
